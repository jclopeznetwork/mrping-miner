...
var TelegramApi = function (params)
{
     ...
     * METHOD: sendPoll
     * PARAMS:
     *       chat_id                     [Required] Unique identifier for the message recepient — User or GroupChat id
     *       question                    [Required] Poll question, 1-255 characters
     *       options                     [Required] An array list of answer options, 2-10 strings 1-100 characters each
     ...
     *       reply_to_message_id         If the message is a reply, ID of the original message
     *       reply_markup                Additional interface options. A JSON-serialized object for a custom reply keyboard, instructions to hide keyboard or to force a reply from the user.
     */
    this.sendPoll = function (params, cb)
    {
 
        params.options = JSON.stringify(params.options); // the API expects a JSON-serialized list
     ...
     */
    this.setChatTitle = function (params, cb)
    {
        return new Promise(function(resolve, reject)
        {
            _rest({
